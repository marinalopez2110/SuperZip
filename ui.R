                    ...
                    div(class="outer",
                        ...
                        absolutePanel(id = "controls", class = "panel panel-default", fixed = TRUE,
                                ...
                                conditionalPanel(condition = "input.Echele == 'Domaines bioclimatiques' && (input.Sousregions =='deux' || input.Sousregions =='trois')",
                                                 selectInput("Domaines", "Séléctionez le domaine 2:",
                                                             choices=c('Pessière à mousses', 'Pessière à lichens',
                                                                       'Toundra arctique arbustive', 'Érablière à caryer cordiforme',
                                                                       'Érablière à tilleul', 'Érablière à bouleau jaune',
                                                                       'Sapinière à bouleau jaune', 'Golfe du Saint-Laurent',
                                ...
                                conditionalPanel(condition = "input.Echele == 'Sous-domaines bioclimatiques' && (input.Sousregions =='deux' || input.Sousregions =='trois')",
                                                 selectInput("Sous-domaines", "Séléctionez le sous-domaine 2:",
                                                             choices=c("Érablière à tilleul de l'Est", "Érablière à tilleul de l'Ouest",
                                                                       "Érablière à bouleau jaune de l'Ouest",
                                                                       "Sapinière à bouleau jaune de l'Ouest",
                                                                       "Sapinière à bouleau blanc de l'Est",
                                ...
                                conditionalPanel(condition = "input.Echele == 'Régions écologiques' && (input.Sousregions =='deux' || input.Sousregions =='trois')",
                                                 selectInput("RegEcol", "Séléctionez la région 2:",
                                                             choices=c('Collines de la basse Gatineau',
                                                                       "Collines de l'Outaouais et du Témiscamingue",
                                                                       'Plaines et coteaux du lac Simard', "Plaine de l'Abitibi",
                                                                       'Plaine du lac Matagami', 'Plaine du Saint-Laurent',
                                ...
                                conditionalPanel(condition = "input.Echele == 'Sous-région écologiques' && (input.Sousregions =='deux' || input.Sousregions =='trois')",
                                                 selectInput("SousRegEcol", "Séléctionez la sous-région 2:",
                                                             choices=c('Collines du lac Dumont', 'Hautes collines du lac Simon',
                                                                       'Collines du lac Notawassi', 'Collines de Saint-Jérôme-Grand-Mère',
                                                                       'Hautes collines du lac Édouard',
                                                                       'Collines du Grand-Lac-Bostonnais',
                                ...
                                conditionalPanel(condition = "input.Echele == 'Unités d'aménagement (UA)' && (input.Sousregions =='deux' || input.Sousregions =='trois')",
                                                 selectInput("UA", "Séléctionez l'unité 2:",
                                                             choices=c('05151', '06452', '07151', '01171', '09352', '02571', '08351',
                                                                       '08751', '07451', '08451', '04352', '04251', '02471', '08764',
                                                                       '11262', '09751', '04351', '09351', '08762', '06151', '08663',
                                                                       '07251', '07352', '03571', '09471', '06471', '03153', '03171',
                                ...
                                conditionalPanel(condition = "input.Echele == 'Domaines bioclimatiques' &&  input.Sousregions =='trois'",
                                                 selectInput("Domaines", "Séléctionez le domaine 3:",
                                                             choices=c('Pessière à mousses', 'Pessière à lichens',
                                                                       'Toundra arctique arbustive', 'Érablière à caryer cordiforme',
                                                                       'Érablière à tilleul', 'Érablière à bouleau jaune',
                                                                       'Sapinière à bouleau jaune', 'Golfe du Saint-Laurent',
                                ...
                                conditionalPanel(condition = "input.Echele == 'Sous-domaines bioclimatiques' && input.Sousregions =='trois'",
                                                 selectInput("Sous-domaines", "Séléctionez le sous-domaine 3:",
                                                             choices=c("Érablière à tilleul de l'Est", "Érablière à tilleul de l'Ouest",
                                                                       "Érablière à bouleau jaune de l'Ouest",
                                                                       "Sapinière à bouleau jaune de l'Ouest",
                                                                       "Sapinière à bouleau blanc de l'Est",
                                ...
                                conditionalPanel(condition = "input.Echele == 'Régions écologiques' && input.Sousregions =='trois'",
                                                 selectInput("RegEcol", "Séléctionez la région 3:",
                                                             choices=c('Collines de la basse Gatineau',
                                                                       "Collines de l'Outaouais et du Témiscamingue",
                                                                       'Plaines et coteaux du lac Simard', "Plaine de l'Abitibi",
                                                                       'Plaine du lac Matagami', 'Plaine du Saint-Laurent',
                                ...
                                conditionalPanel(condition = "input.Echele == 'Sous-région écologiques' && input.Sousregions =='trois'",
                                                 selectInput("SousRegEcol", "Séléctionez la sous-région 3:",
                                                             choices=c('Collines du lac Dumont', 'Hautes collines du lac Simon',
                                                                       'Collines du lac Notawassi', 'Collines de Saint-Jérôme-Grand-Mère',
                                                                       'Hautes collines du lac Édouard',
                                                                       'Collines du Grand-Lac-Bostonnais',
                                ...
                                conditionalPanel(condition = "input.Echele == 'Secteurs des opérations régionales' && input.Sousregions =='trois'",
                                                 selectInput("Secteurs", "Séléctionez le secteur 3:",
                                                             choices=c('Sud-Ouest', 'Centre du Québec', 'Nord-est',
                                                                       'Secteur métropolitain et sud', 'Sud-est', 'Nord-ouest'))),                
                                ...
                                conditionalPanel(condition = "input.Echele == 'Unités d'aménagement (UA)' && input.Sousregions =='trois'",
                                                 selectInput("UA", "Séléctionez l'unité 3:",
                                                             choices=c('05151', '06452', '07151', '01171', '09352', '02571', '08351',
                                                                       '08751', '07451', '08451', '04352', '04251', '02471', '08764',
                                                                       '11262', '09751', '04351', '09351', '08762', '06151', '08663',
                                                                       '07251', '07352', '03571', '09471', '06471', '03153', '03171',
                                      ...
                                      conditionalPanel(condition = "input.Variable == 'Températures moyennes, min et max'",
                                                       ...
                                                       actionButton("Maximum", HTML("Moyenne des températures maximales <br> quotidiennes (Â°C)")),
                                                       actionButton("Minimum",HTML("Moyenne des températures minimales <br> quotidiennes (Â°C)"))),
