                        ...
                        absolutePanel(id = "controls", class = "panel panel-default", fixed = TRUE,
                                ...
                                ###Échele spatiale
                                      ...
                                      radioButtons("Sousregions", "Nombre de sous-régions que vous souhaitez voir:",
                                                   c("1" = "un",  "2" = "deux", "Toutes" =  "Toutes"), inline = TRUE),
                                      
                                      
                                  #### Une région     
                                      conditionalPanel(condition = "input.Echele == 'Domaines bioclimatiques' && (input.Sousregions =='un' || input.Sousregions =='deux')",
                                      ...
                                      conditionalPanel(condition = "input.Echele == 'Sous-domaines bioclimatiques' && (input.Sousregions =='un' || input.Sousregions =='deux')",
                                      ...
                                      conditionalPanel(condition = "input.Echele == 'Régions écologiques' && (input.Sousregions =='un' || input.Sousregions =='deux')",
                                      ...
                                      conditionalPanel(condition = "input.Echele == 'Sous-région écologiques' && (input.Sousregions =='un' || input.Sousregions =='deux')",
                                      ...
                                      conditionalPanel(condition = "input.Echele == 'Territoires guides' && (input.Sousregions =='un' || input.Sousregions =='deux')",
                                      ...
                                      conditionalPanel(condition = "input.Echele == 'Secteurs des opérations régionales' && (input.Sousregions =='un' || input.Sousregions =='deux')",
                                      ...
                                      conditionalPanel(condition = "input.Echele == 'Régions forestières' && (input.Sousregions =='un' || input.Sousregions =='deux')",
                                                       selectInput("RegForest", "Séléctionez la région:",
                                                                   choices=c( 'Bas-Saint-Laurent', 'Saguenay -Lac-Saint-Jean',
                                                                              ...
                                                                              'Laurentides'))),                
                                      conditionalPanel(condition = "input.Echele == 'Unités d’aménagement (UA)' && (input.Sousregions =='un' || input.Sousregions =='deux')",
                                                       selectInput("UA", "Séléctionez l'unité:",
                                                                   choices=c('05151', '06452', '07151', '01171', '09352', '02571', '08351',
                                                                             ...
                                                                             '03451', '02371', '08562'))),  
                                #### Deux régions     
                                conditionalPanel(condition = "input.Echele == 'Domaines bioclimatiques' && input.Sousregions =='deux'",
                                                 selectInput("Domaines", "Séléctionez le domaine 2:",
                                                             choices=c('Pessière à mousses', 'Pessière à lichens',
                                                                       ...
                                                                       'Sapinière à bouleau blanc', 'Toundra forestière',
                                                                       'Toundra arctique herbacée' ))),
                                conditionalPanel(condition = "input.Echele == 'Sous-domaines bioclimatiques' && input.Sousregions =='deux'",
                                                 selectInput("Sous-domaines", "Séléctionez le sous-domaine 2:",
                                                             choices=c("Érablière à tilleul de l'Est", "Érablière à tilleul de l'Ouest",
                                                                       ...
                                                                       "Sapinière à bouleau jaune de l'Est", 'Golfe du Saint-Laurent',
                                                                       "Pessière à mousses de l'Ouest" ))),
                                conditionalPanel(condition = "input.Echele == 'Régions écologiques' && input.Sousregions =='deux'",
                                                 selectInput("RegEcol", "Séléctionez la région 2:",
                                                             choices=c('Collines de la basse Gatineau',
                                                                       ...
                                                                       'Collines de Havre-Saint-Pierre et de Blanc-Sablon',
                                                                       'Coteaux du lac Fonteneau' ))),
                                conditionalPanel(condition = "input.Echele == 'Sous-région écologiques' && input.Sousregions =='deux'",
                                                 selectInput("SousRegEcol", "Séléctionez la sous-région 2:",
                                                             choices=c('Collines du lac Dumont', 'Hautes collines du lac Simon',
                                                                       ...
                                                                       'Coteaux de la rivière à la Croix et du lac au Griffon',
                                                                       'Coteaux de Natashquan'))),
                                conditionalPanel(condition = "input.Echele == 'Territoires guides' && input.Sousregions =='deux'",
                                                 selectInput("Territoires", "Séléctionez le territoire 2:",
                                                             choices=c( '1a', '2a', '2b', '2c', '3ab', '3c', '3d', '4a', '4bc', '4de',
                                                                        '4f', '4gh', '5a', '5bcd', '5ef', '5g', '5hi', '5jk', '6ab',
                                                                        '6cdefg', '6hi', '6j', '6kl', '6mn', '6opqr'))),
                                conditionalPanel(condition = "input.Echele == 'Secteurs des opérations régionales' && input.Sousregions =='deux'",
                                                 selectInput("Secteurs", "Séléctionez le secteur 2:",
                                                             choices=c('Sud-Ouest', 'Centre du Québec', 'Nord-est',
                                                                       'Secteur métropolitain et sud', 'Sud-est', 'Nord-ouest'))),                
                                conditionalPanel(condition = "input.Echele == 'Régions forestières' && input.Sousregions =='deux'",
                                                 selectInput("RegForest", "Séléctionez la région 2:",
                                                             choices=c( 'Bas-Saint-Laurent', 'Saguenay -Lac-Saint-Jean',
                                                                        ...
                                                                        'Nord-Du-Québec', 'Gaspésie-Iles-De-La-Madeleine', 'Lanaudière',
                                                                        'Laurentides'))),                
                                conditionalPanel(condition = "input.Echele == 'Unités d’aménagement (UA)' && input.Sousregions =='deux'",
