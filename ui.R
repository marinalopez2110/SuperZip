                                ...
                                ###Échele spatiale
                                  ...
                                  #### Une région     
                                      conditionalPanel(condition = "input.Echele == 'Domaines bioclimatiques' && (input.Sousregions =='un' || input.Sousregions =='deux' || input.Sousregions =='trois')",
                                                       selectInput("Domaines", "Sélectionnez  le domaine :",
                                                                   choices= DomainesC)),
                                      conditionalPanel(condition = "input.Echele == 'Sous-domaines bioclimatiques' && (input.Sousregions =='un' || input.Sousregions =='deux' || input.Sousregions =='trois')",
                                                       selectInput("Sousdomaines", "Sélectionnez  le sous-domaine:",
                                      ...
                                      conditionalPanel(condition = "input.Echele == 'Régions écologiques' && (input.Sousregions =='un' || input.Sousregions =='deux' || input.Sousregions =='trois')",
                                                       selectInput("RegEcol", "Sélectionnez  la région:",
                                                                   choices= RegEcolC)),
                                      conditionalPanel(condition = "input.Echele == 'Sous-région écologiques' && (input.Sousregions =='un' || input.Sousregions =='deux' || input.Sousregions =='trois')",
                                                       selectInput("SousRegEcol", "Sélectionnez  la sous-région:",
                                      ...
                                      conditionalPanel(condition = "input.Echele == 'Régions forestières' && (input.Sousregions =='un' || input.Sousregions =='deux' || input.Sousregions =='trois')",
                                                       selectInput("RegForest", "Sélectionnez  la région:",
                                                                   choices=RegForestC)),                
